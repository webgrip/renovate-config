...
import { Json, Toml } from "../schema.js";
...
const PipenvConstraintObject = z
    ...
    .nullable()
    .catch(null);
const PipfileLock = Json.pipe(z.object({
...
const PipfilePipenvConstraint = Toml.pipe(PythonConstraintObject)
    ...
    .catch(null);
export async function getPythonConstraint(path) {
...
export async function getPipenvConstraint(path) {
    const pipfileContent = await readFile(path, 'Pipfile');
