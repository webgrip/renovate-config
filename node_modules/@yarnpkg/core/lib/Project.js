...
class Project {
    ...
    async persistInstallStateFile() {
        ...
        const installState = (0, compat_1.pick)(this, fields);
    ...
    async restoreInstallState({ restoreLinkersCustomData = true, restoreResolutions = true, restoreBuildState = true } = {}) {
        ...
        if (restoreBuildState)
            Object.assign(this, (0, compat_1.pick)(installState, INSTALL_STATE_FIELDS.restoreBuildState));
        ...
        if (restoreResolutions) {
            if (installState.lockFileChecksum === this.lockFileChecksum) {
                Object.assign(this, (0, compat_1.pick)(installState, INSTALL_STATE_FIELDS.restoreResolutions));
            }
            else {
                await this.applyLightResolution();
            }
...
function applyVirtualResolutionMutations({ project, allDescriptors, allResolutions, allPackages, accessibleLocators = new Set(), optionalBuilds = new Set(), peerRequirements = new Map(), peerWarnings = [], peerRequirementNodes = new Map(), volatileDescriptors = new Set(), }) {
    ...
    const allVirtualResolutions = new Map();
    ...
    const resolvePeerDependenciesImpl = (parentDescriptor, parentLocator, parentPeerRequests, { top, optional }) => {
        ...
        const dedupeCandidates = new Set();
        ...
        for (const locatorHash of dedupeCandidates) {
            ...
            const dependencyHash = hashUtils.makeHash(structUtils.devirtualizeLocator(virtualPackage).locatorHash, ...Array.from(virtualPackage.dependencies.values(), descriptor => {
