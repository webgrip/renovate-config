...
import { managerDefaultConfigs } from "../../manager-default-configs.generated.js";
...
//#region lib/config/options/index.ts
const options = [
	{
		name: "mode",
...
function freezeConfigOptions() {
	for (const option of options) freeze(option);
}
loadManagerOptions();
freezeConfigOptions();
//#endregion
