//#region lib/config/presets/internal/workarounds.preset.ts
const presets = {
	all: {
	...
	containerbase: {
		...
		packageRules: [{
			...
			matchDatasources: ["docker"],
			matchPackageNames: ["/^(?:(?:docker|ghcr)\\.io/)?(?:containerbase|renovate)/node$/"],
			versioning: "node"
		}]
	},
	...
	ignoreSpringCloudNumeric: {
		...
		packageRules: [{
			allowedVersions: "/^[A-Z]/",
			matchDatasources: ["maven"],
			matchPackageNames: ["org.springframework.cloud:spring-cloud-starter-parent"]
		}]
	},
	...
	javaLTSVersions: {
		...
		packageRules: [
			...
			},
			{
				...
				description: "Limit Java runtime versions to LTS releases. To receive all major releases add `workarounds:javaLTSVersions` to the `ignorePresets` array.",
				matchDatasources: ["docker"],
				matchPackageNames: ["bellsoft/hardened-liberica-runtime-container", "bellsoft/liberica-runtime-container"]
			}
		]
	},
...
//# sourceMappingURL=workarounds.preset.js.map