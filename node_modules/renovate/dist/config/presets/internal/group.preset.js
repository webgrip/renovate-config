import { presets as presets$1 } from "./monorepos.preset.js";
//#region lib/config/presets/internal/group.preset.ts
const nonPinUpdateTypes = [
	"digest",
	"patch",
	"minor",
	"major"
...
const config = {
	...
	jekyllEcosystem: {
		...
		packageRules: [{
			...
			matchSourceUrls: ["https://github.com/jekyll/**", "https://github.com/github/pages-gem**"]
		}]
	},
	jestPlusTSJest: {
...
const monorepoNames = [];
for (const monorepo of Object.keys(presets$1)) {
	const name = `${monorepo}Monorepo`;
	monorepoNames.push(`group:${name}`);
	config[name] = { packageRules: [{
...
//# sourceMappingURL=group.preset.js.map