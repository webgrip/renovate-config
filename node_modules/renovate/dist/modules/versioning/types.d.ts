...
//#region lib/modules/versioning/types.d.ts
interface NewValueConfig {
  currentValue: string;
...
type VersioningApiConstructor = new (config?: string) => VersioningApi;
//#endregion
export { NewValueConfig, VersioningApi, VersioningApiConstructor };
