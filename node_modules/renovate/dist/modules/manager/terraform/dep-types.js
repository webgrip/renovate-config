//#region lib/modules/manager/terraform/dep-types.ts
const knownDepTypes = [
	{
		depType: "module",
	...
	},
	{
		...
		description: "A Terraform provider declared in a `required_providers` block"
	},
	{
		depType: "required_version",
		description: "The Terraform version constraint in a `required_version` field"
	},
	{
	...
	},
	{
		...
		description: "A container image in a `kubernetes_replication_controller` resource"
	},
	{
		depType: "kubernetes_replication_controller_v1",
		description: "A container image in a `kubernetes_replication_controller_v1` resource"
	},
	{
