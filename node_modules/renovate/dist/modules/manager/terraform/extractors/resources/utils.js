//#region lib/modules/manager/terraform/extractors/resources/utils.ts
const KubernetesSpecContainer = [
	"spec",
	"container",
	"image"
];
const KubernetesSpecInitContainer = [
	"spec",
	"init_container",
	"image"
];
...
const generic_image_datasource = [{
	type: "docker_registry_image",
	path: ["name"]
}];
const generic_image_resource = [
	{
		type: "docker_image",
		path: ["name"]
	},
	...
	{
		type: "kubernetes_pod",
		path: KubernetesSpecContainer
	},
	{
		type: "kubernetes_pod",
		path: KubernetesSpecInitContainer
	},
	{
	...
	},
	{
		...
		path: KubernetesJobTemplate
	},
	{
		type: "kubernetes_cron_job",
		path: KubernetesJobTemplateInit
	},
	{
...
//#endregion
export { generic_image_datasource, generic_image_resource };
