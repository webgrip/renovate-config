//#region lib/modules/manager/pep621/dep-types.ts
const knownDepTypes = [
	{
...
const supportsDynamicDepTypesNote = "Hatch environments produce dynamic `depType` values in the form `tool.hatch.envs.<env-name>`.";
//#endregion
