//#region lib/modules/manager/github-actions/dep-types.ts
const knownDepTypes = [
	{
		depType: "action",
	...
	},
	{
		...
		description: "A GitHub-hosted runner version in a `runs-on:` field (e.g. `ubuntu-24.04`)"
	},
	{
		depType: "uses-with",
		description: "A language/runtime version passed as an input to a versioned action (e.g. `node-version` for `actions/setup-node`)"
	}
];
//#endregion
