//#region lib/modules/manager/npm/dep-types.ts
const pnpmWorkspaceOverrides = "pnpm-workspace.overrides";
const knownDepTypes = [
	{
...
const supportsDynamicDepTypesNote = "Additionally, catalog dependencies produce dynamic `depType` values: `pnpm.catalog.<name>` for [pnpm catalogs](https://pnpm.io/catalogs#defining-catalogs) and `yarn.catalog.<name>` for [yarn catalogs](https://yarnpkg.com/features/catalogs).";
//#endregion
export { knownDepTypes, pnpmWorkspaceOverrides, supportsDynamicDepTypesNote };
