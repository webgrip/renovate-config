//#region lib/modules/manager/bazel/dep-types.ts
const knownDepTypes = [
	{
	...
	},
	{
		...
		description: "A Docker container image pulled via the private `_container_pull` rule"
	},
	{
	...
	},
	{
		...
		description: "A Git repository dependency via the private `_git_repository` rule"
	},
	{
		depType: "new_git_repository",
		description: "A Git repository with a custom BUILD file via `new_git_repository`"
	},
	{
		depType: "_new_git_repository",
		description: "A Git repository with a custom BUILD file via the private `_new_git_repository` rule"
	},
	{
	...
	},
	{
		...
		description: "An archive downloaded over HTTP via the private `_http_archive` rule"
	},
	{
		depType: "http_file",
	...
	{
		depType: "_http_file",
		description: "A file downloaded over HTTP via the private `_http_file` rule"
	},
	{
		depType: "oci_pull",
	...
	{
		depType: "_oci_pull",
		description: "An OCI container image pulled via the private `_oci_pull` rule"
	},
	{
	...
	},
	{
		...
		description: "A Maven artifact installed via the private `_maven_install` rule"
	}
];
//#endregion
