	...
	if (hasDeprecationsOrReplacements) {
		...
		for (const manager of Object.keys(deprecatedPackages).sort()) {
			...
			for (const depName of Object.keys(deps).sort()) {
				...
				issueBody += `| ${manager} | ${packageName} | ${hasReplacement ? "![Available](https://img.shields.io/badge/available-green?style=flat-square)" : "![Unavailable](https://img.shields.io/badge/unavailable-orange?style=flat-square)"} |\n`;
			}
		}
		issueBody += "\n";
	}
