...
//#region lib/workers/repository/update/pr/changelog/common.ts
...
function compareChangelogFilePath(a, b) {
	...
	if (aPreferedIndex === bPreferedIndex) return a.localeCompare(b);
	else if (aPreferedIndex >= 0 && bPreferedIndex >= 0) return aPreferedIndex - bPreferedIndex;
	return aPreferedIndex >= 0 ? -1 : 1;
}
//#endregion
export { compareChangelogFilePath, slugifyUrl };
