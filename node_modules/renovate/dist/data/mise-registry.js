...
var mise_registry_default = {
	...
	tools: {
		...
		"checkmake": { "aqua": "checkmake/checkmake" },
		"checkov": {
		...
		"code": { "aqua": "just-every/code" },
		"code-review-graph": { "pipx": "code-review-graph" },
		...
		"flux-operator": { "aqua": "controlplaneio-fluxcd/flux-operator" },
		"flux-operator-mcp": { "aqua": "controlplaneio-fluxcd/flux-operator/flux-operator-mcp" },
		"flux2": {
			"aqua": "fluxcd/flux2",
		...
		"git-filter-repo": { "pipx": "git-filter-repo" },
		...
		"google-java-format": { "aqua": "google/google-java-format" },
		"gopass": {
		...
		"grafana-kubernetes-plugin": { "aqua": "ricoberger/grafana-kubernetes-plugin" },
		"granted": {
		...
		"kiro-cli": { "aqua": "kiro.dev/kiro-cli" },
		"kn": {
			"aqua": "knative/client",
			"asdf": "joke/asdf-kn"
		},
		...
		"mysql-client": { "conda": "mysql-client" },
		...
		"openshift-install": { "http": "openshift-install" },
		"opentofu": {
		...
		"racket": { "aqua": "racket/racket/minimal" },
		"railway": {
			"cargo": "railwayapp",
		...
		"scalafmt": { "github": "scalameta/scalafmt" },
		"scaleway": {
		...
		"sonarqube-cli": { "aqua": "SonarSource/sonarqube-cli" },
		"sonobuoy": {
		...
		"systemctl-tui": { "aqua": "rgwood/systemctl-tui" },
		...
		"umoci": { "aqua": "opencontainers/umoci" },
		"unison": {
		...
		"wasm-tools": {
			"aqua": "bytecodealliance/wasm-tools",
			"cargo": "wasm-tools"
		},
		"wasmer": {
		...
		"yara-x": { "github": "VirusTotal/yara-x" },
		"yarn": {
			"aqua": "yarnpkg/berry",
