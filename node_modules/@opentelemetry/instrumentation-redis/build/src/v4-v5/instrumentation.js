...
class RedisInstrumentationV4_V5 extends instrumentation_1.InstrumentationBase {
    ...
    _getInstrumentationNodeModuleDefinition(basePackageName) {
        ...
        const clusterIndexModule = new instrumentation_1.InstrumentationNodeModuleFile(`${basePackageName}/dist/lib/cluster/index.js`, ['^1.0.0', '^5.0.0'], (moduleExports) => {
        ...
        const clusterMultiCommanderModule = new instrumentation_1.InstrumentationNodeModuleFile(`${basePackageName}/dist/lib/cluster/multi-command.js`, ['^1.0.0', '^5.0.0'], (moduleExports) => {
