...
declare const DescribeIpamPoolAllocationsCommand_base: {
    new (input: DescribeIpamPoolAllocationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamPoolAllocationsCommandInput, DescribeIpamPoolAllocationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPoolAllocationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamPoolAllocationsCommandInput, DescribeIpamPoolAllocationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
