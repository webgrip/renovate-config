...
declare const GetSerialConsoleAccessStatusCommand_base: {
    new (input: GetSerialConsoleAccessStatusCommandInput): import("@smithy/core/client").CommandImpl<GetSerialConsoleAccessStatusCommandInput, GetSerialConsoleAccessStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetSerialConsoleAccessStatusCommandInput]): import("@smithy/core/client").CommandImpl<GetSerialConsoleAccessStatusCommandInput, GetSerialConsoleAccessStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
