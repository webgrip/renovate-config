...
import type { ModifyIpamPrefixListResolverTargetRequest, ModifyIpamPrefixListResolverTargetResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyIpamPrefixListResolverTargetCommand_base: {
    new (input: ModifyIpamPrefixListResolverTargetCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPrefixListResolverTargetCommandInput, ModifyIpamPrefixListResolverTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyIpamPrefixListResolverTargetCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPrefixListResolverTargetCommandInput, ModifyIpamPrefixListResolverTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
