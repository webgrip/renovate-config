...
import type { ModifyInstanceCpuOptionsRequest, ModifyInstanceCpuOptionsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyInstanceCpuOptionsCommand_base: {
    new (input: ModifyInstanceCpuOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCpuOptionsCommandInput, ModifyInstanceCpuOptionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyInstanceCpuOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCpuOptionsCommandInput, ModifyInstanceCpuOptionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
