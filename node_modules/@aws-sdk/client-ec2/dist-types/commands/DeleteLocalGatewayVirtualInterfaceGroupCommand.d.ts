...
import type { DeleteLocalGatewayVirtualInterfaceGroupRequest, DeleteLocalGatewayVirtualInterfaceGroupResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteLocalGatewayVirtualInterfaceGroupCommand_base: {
    new (input: DeleteLocalGatewayVirtualInterfaceGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayVirtualInterfaceGroupCommandInput, DeleteLocalGatewayVirtualInterfaceGroupCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteLocalGatewayVirtualInterfaceGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayVirtualInterfaceGroupCommandInput, DeleteLocalGatewayVirtualInterfaceGroupCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
