...
declare const DescribeRouteServersCommand_base: {
    new (input: DescribeRouteServersCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteServersCommandInput, DescribeRouteServersCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRouteServersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRouteServersCommandInput, DescribeRouteServersCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
