...
import type { DescribeScheduledInstanceAvailabilityRequest, DescribeScheduledInstanceAvailabilityResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeScheduledInstanceAvailabilityCommand_base: {
    new (input: DescribeScheduledInstanceAvailabilityCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledInstanceAvailabilityCommandInput, DescribeScheduledInstanceAvailabilityCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeScheduledInstanceAvailabilityCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledInstanceAvailabilityCommandInput, DescribeScheduledInstanceAvailabilityCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
