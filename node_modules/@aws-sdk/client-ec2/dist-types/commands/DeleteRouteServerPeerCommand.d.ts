...
declare const DeleteRouteServerPeerCommand_base: {
    new (input: DeleteRouteServerPeerCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteServerPeerCommandInput, DeleteRouteServerPeerCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteRouteServerPeerCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteServerPeerCommandInput, DeleteRouteServerPeerCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
