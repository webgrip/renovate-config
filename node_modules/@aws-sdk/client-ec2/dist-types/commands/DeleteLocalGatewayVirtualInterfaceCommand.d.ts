...
import type { DeleteLocalGatewayVirtualInterfaceRequest, DeleteLocalGatewayVirtualInterfaceResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteLocalGatewayVirtualInterfaceCommand_base: {
    new (input: DeleteLocalGatewayVirtualInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayVirtualInterfaceCommandInput, DeleteLocalGatewayVirtualInterfaceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteLocalGatewayVirtualInterfaceCommandInput): import("@smithy/core/client").CommandImpl<DeleteLocalGatewayVirtualInterfaceCommandInput, DeleteLocalGatewayVirtualInterfaceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
