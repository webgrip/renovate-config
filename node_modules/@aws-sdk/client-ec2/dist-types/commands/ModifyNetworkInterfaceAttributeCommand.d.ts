...
import type { ModifyNetworkInterfaceAttributeRequest } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyNetworkInterfaceAttributeCommand_base: {
    new (input: ModifyNetworkInterfaceAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyNetworkInterfaceAttributeCommandInput, ModifyNetworkInterfaceAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyNetworkInterfaceAttributeCommandInput): import("@smithy/core/client").CommandImpl<ModifyNetworkInterfaceAttributeCommandInput, ModifyNetworkInterfaceAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
