...
declare const DescribeTrafficMirrorFilterRulesCommand_base: {
    new (input: DescribeTrafficMirrorFilterRulesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorFilterRulesCommandInput, DescribeTrafficMirrorFilterRulesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTrafficMirrorFilterRulesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorFilterRulesCommandInput, DescribeTrafficMirrorFilterRulesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
