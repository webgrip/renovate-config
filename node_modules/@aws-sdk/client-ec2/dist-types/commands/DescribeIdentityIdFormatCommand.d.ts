...
declare const DescribeIdentityIdFormatCommand_base: {
    new (input: DescribeIdentityIdFormatCommandInput): import("@smithy/core/client").CommandImpl<DescribeIdentityIdFormatCommandInput, DescribeIdentityIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeIdentityIdFormatCommandInput): import("@smithy/core/client").CommandImpl<DescribeIdentityIdFormatCommandInput, DescribeIdentityIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
