...
import type { StartDeclarativePoliciesReportRequest, StartDeclarativePoliciesReportResult } from "../models/models_7";
/**
 * @public
 */
...
declare const StartDeclarativePoliciesReportCommand_base: {
    new (input: StartDeclarativePoliciesReportCommandInput): import("@smithy/core/client").CommandImpl<StartDeclarativePoliciesReportCommandInput, StartDeclarativePoliciesReportCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StartDeclarativePoliciesReportCommandInput): import("@smithy/core/client").CommandImpl<StartDeclarativePoliciesReportCommandInput, StartDeclarativePoliciesReportCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
