...
declare const DescribeBundleTasksCommand_base: {
    new (input: DescribeBundleTasksCommandInput): import("@smithy/core/client").CommandImpl<DescribeBundleTasksCommandInput, DescribeBundleTasksCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeBundleTasksCommandInput]): import("@smithy/core/client").CommandImpl<DescribeBundleTasksCommandInput, DescribeBundleTasksCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
