...
declare const DescribeTransitGatewayRouteTablesCommand_base: {
    new (input: DescribeTransitGatewayRouteTablesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayRouteTablesCommandInput, DescribeTransitGatewayRouteTablesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayRouteTablesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayRouteTablesCommandInput, DescribeTransitGatewayRouteTablesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
