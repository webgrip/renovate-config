...
declare const DeprovisionIpamByoasnCommand_base: {
    new (input: DeprovisionIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionIpamByoasnCommandInput, DeprovisionIpamByoasnCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeprovisionIpamByoasnCommandInput): import("@smithy/core/client").CommandImpl<DeprovisionIpamByoasnCommandInput, DeprovisionIpamByoasnCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
