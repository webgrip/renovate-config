...
import type { TerminateInstancesRequest, TerminateInstancesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const TerminateInstancesCommand_base: {
    new (input: TerminateInstancesCommandInput): import("@smithy/core/client").CommandImpl<TerminateInstancesCommandInput, TerminateInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: TerminateInstancesCommandInput): import("@smithy/core/client").CommandImpl<TerminateInstancesCommandInput, TerminateInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
