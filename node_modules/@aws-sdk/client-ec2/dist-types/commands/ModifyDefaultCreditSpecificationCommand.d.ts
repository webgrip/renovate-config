...
import type { ModifyDefaultCreditSpecificationRequest, ModifyDefaultCreditSpecificationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyDefaultCreditSpecificationCommand_base: {
    new (input: ModifyDefaultCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyDefaultCreditSpecificationCommandInput, ModifyDefaultCreditSpecificationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyDefaultCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyDefaultCreditSpecificationCommandInput, ModifyDefaultCreditSpecificationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
