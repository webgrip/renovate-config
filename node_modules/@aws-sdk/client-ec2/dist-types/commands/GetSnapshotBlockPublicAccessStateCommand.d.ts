...
declare const GetSnapshotBlockPublicAccessStateCommand_base: {
    new (input: GetSnapshotBlockPublicAccessStateCommandInput): import("@smithy/core/client").CommandImpl<GetSnapshotBlockPublicAccessStateCommandInput, GetSnapshotBlockPublicAccessStateCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetSnapshotBlockPublicAccessStateCommandInput]): import("@smithy/core/client").CommandImpl<GetSnapshotBlockPublicAccessStateCommandInput, GetSnapshotBlockPublicAccessStateCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
