...
import type { ModifyInstanceMaintenanceOptionsRequest, ModifyInstanceMaintenanceOptionsResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyInstanceMaintenanceOptionsCommand_base: {
    new (input: ModifyInstanceMaintenanceOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceMaintenanceOptionsCommandInput, ModifyInstanceMaintenanceOptionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyInstanceMaintenanceOptionsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceMaintenanceOptionsCommandInput, ModifyInstanceMaintenanceOptionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
