...
declare const DescribeReservedInstancesOfferingsCommand_base: {
    new (input: DescribeReservedInstancesOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesOfferingsCommandInput, DescribeReservedInstancesOfferingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeReservedInstancesOfferingsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesOfferingsCommandInput, DescribeReservedInstancesOfferingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
