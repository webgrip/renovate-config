...
import type { ExportClientVpnClientConfigurationRequest, ExportClientVpnClientConfigurationResult } from "../models/models_5";
/**
 * @public
 */
...
declare const ExportClientVpnClientConfigurationCommand_base: {
    new (input: ExportClientVpnClientConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ExportClientVpnClientConfigurationCommandInput, ExportClientVpnClientConfigurationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ExportClientVpnClientConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ExportClientVpnClientConfigurationCommandInput, ExportClientVpnClientConfigurationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
