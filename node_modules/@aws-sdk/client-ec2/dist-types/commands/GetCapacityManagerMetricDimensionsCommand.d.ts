...
import type { GetCapacityManagerMetricDimensionsRequest, GetCapacityManagerMetricDimensionsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const GetCapacityManagerMetricDimensionsCommand_base: {
    new (input: GetCapacityManagerMetricDimensionsCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityManagerMetricDimensionsCommandInput, GetCapacityManagerMetricDimensionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetCapacityManagerMetricDimensionsCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityManagerMetricDimensionsCommandInput, GetCapacityManagerMetricDimensionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
