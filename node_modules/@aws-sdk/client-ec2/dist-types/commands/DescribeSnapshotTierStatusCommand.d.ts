...
declare const DescribeSnapshotTierStatusCommand_base: {
    new (input: DescribeSnapshotTierStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeSnapshotTierStatusCommandInput, DescribeSnapshotTierStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSnapshotTierStatusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSnapshotTierStatusCommandInput, DescribeSnapshotTierStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
