...
declare const GetActiveVpnTunnelStatusCommand_base: {
    new (input: GetActiveVpnTunnelStatusCommandInput): import("@smithy/core/client").CommandImpl<GetActiveVpnTunnelStatusCommandInput, GetActiveVpnTunnelStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetActiveVpnTunnelStatusCommandInput): import("@smithy/core/client").CommandImpl<GetActiveVpnTunnelStatusCommandInput, GetActiveVpnTunnelStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
