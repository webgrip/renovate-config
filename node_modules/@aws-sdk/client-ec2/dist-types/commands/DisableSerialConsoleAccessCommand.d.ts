...
declare const DisableSerialConsoleAccessCommand_base: {
    new (input: DisableSerialConsoleAccessCommandInput): import("@smithy/core/client").CommandImpl<DisableSerialConsoleAccessCommandInput, DisableSerialConsoleAccessCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DisableSerialConsoleAccessCommandInput]): import("@smithy/core/client").CommandImpl<DisableSerialConsoleAccessCommandInput, DisableSerialConsoleAccessCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
