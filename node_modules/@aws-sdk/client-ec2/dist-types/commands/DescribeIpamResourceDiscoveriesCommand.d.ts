...
declare const DescribeIpamResourceDiscoveriesCommand_base: {
    new (input: DescribeIpamResourceDiscoveriesCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamResourceDiscoveriesCommandInput, DescribeIpamResourceDiscoveriesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamResourceDiscoveriesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamResourceDiscoveriesCommandInput, DescribeIpamResourceDiscoveriesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
