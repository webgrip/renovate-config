...
declare const DescribeInstanceTypeOfferingsCommand_base: {
    new (input: DescribeInstanceTypeOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceTypeOfferingsCommandInput, DescribeInstanceTypeOfferingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceTypeOfferingsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceTypeOfferingsCommandInput, DescribeInstanceTypeOfferingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
