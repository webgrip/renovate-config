...
declare const DescribeTransitGatewayConnectPeersCommand_base: {
    new (input: DescribeTransitGatewayConnectPeersCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayConnectPeersCommandInput, DescribeTransitGatewayConnectPeersCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayConnectPeersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayConnectPeersCommandInput, DescribeTransitGatewayConnectPeersCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
