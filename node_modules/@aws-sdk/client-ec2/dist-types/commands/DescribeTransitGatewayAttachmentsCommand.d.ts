...
declare const DescribeTransitGatewayAttachmentsCommand_base: {
    new (input: DescribeTransitGatewayAttachmentsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayAttachmentsCommandInput, DescribeTransitGatewayAttachmentsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayAttachmentsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayAttachmentsCommandInput, DescribeTransitGatewayAttachmentsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
