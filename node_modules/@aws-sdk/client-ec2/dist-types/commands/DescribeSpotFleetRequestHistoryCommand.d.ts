...
import type { DescribeSpotFleetRequestHistoryRequest, DescribeSpotFleetRequestHistoryResponse } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeSpotFleetRequestHistoryCommand_base: {
    new (input: DescribeSpotFleetRequestHistoryCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetRequestHistoryCommandInput, DescribeSpotFleetRequestHistoryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeSpotFleetRequestHistoryCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetRequestHistoryCommandInput, DescribeSpotFleetRequestHistoryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
