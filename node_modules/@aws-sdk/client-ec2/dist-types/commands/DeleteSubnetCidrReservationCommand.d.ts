...
import type { DeleteSubnetCidrReservationRequest, DeleteSubnetCidrReservationResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteSubnetCidrReservationCommand_base: {
    new (input: DeleteSubnetCidrReservationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSubnetCidrReservationCommandInput, DeleteSubnetCidrReservationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteSubnetCidrReservationCommandInput): import("@smithy/core/client").CommandImpl<DeleteSubnetCidrReservationCommandInput, DeleteSubnetCidrReservationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
