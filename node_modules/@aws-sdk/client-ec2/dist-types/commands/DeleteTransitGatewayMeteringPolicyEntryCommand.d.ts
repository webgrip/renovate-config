...
declare const DeleteTransitGatewayMeteringPolicyEntryCommand_base: {
    new (input: DeleteTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayMeteringPolicyEntryCommandInput, DeleteTransitGatewayMeteringPolicyEntryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteTransitGatewayMeteringPolicyEntryCommandInput): import("@smithy/core/client").CommandImpl<DeleteTransitGatewayMeteringPolicyEntryCommandInput, DeleteTransitGatewayMeteringPolicyEntryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
