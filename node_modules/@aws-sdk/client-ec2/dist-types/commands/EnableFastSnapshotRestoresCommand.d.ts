...
import type { EnableFastSnapshotRestoresRequest, EnableFastSnapshotRestoresResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableFastSnapshotRestoresCommand_base: {
    new (input: EnableFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<EnableFastSnapshotRestoresCommandInput, EnableFastSnapshotRestoresCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<EnableFastSnapshotRestoresCommandInput, EnableFastSnapshotRestoresCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
