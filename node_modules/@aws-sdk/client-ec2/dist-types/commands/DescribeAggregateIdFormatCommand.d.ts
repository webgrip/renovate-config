...
declare const DescribeAggregateIdFormatCommand_base: {
    new (input: DescribeAggregateIdFormatCommandInput): import("@smithy/core/client").CommandImpl<DescribeAggregateIdFormatCommandInput, DescribeAggregateIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAggregateIdFormatCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAggregateIdFormatCommandInput, DescribeAggregateIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
