...
declare const DescribeIpamPoliciesCommand_base: {
    new (input: DescribeIpamPoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamPoliciesCommandInput, DescribeIpamPoliciesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPoliciesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamPoliciesCommandInput, DescribeIpamPoliciesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
