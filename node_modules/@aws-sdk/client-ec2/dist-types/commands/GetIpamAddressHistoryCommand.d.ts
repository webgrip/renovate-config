...
declare const GetIpamAddressHistoryCommand_base: {
    new (input: GetIpamAddressHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetIpamAddressHistoryCommandInput, GetIpamAddressHistoryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetIpamAddressHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetIpamAddressHistoryCommandInput, GetIpamAddressHistoryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
