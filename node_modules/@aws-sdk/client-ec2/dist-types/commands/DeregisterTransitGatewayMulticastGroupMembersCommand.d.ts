...
declare const DeregisterTransitGatewayMulticastGroupMembersCommand_base: {
    new (input: DeregisterTransitGatewayMulticastGroupMembersCommandInput): import("@smithy/core/client").CommandImpl<DeregisterTransitGatewayMulticastGroupMembersCommandInput, DeregisterTransitGatewayMulticastGroupMembersCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DeregisterTransitGatewayMulticastGroupMembersCommandInput]): import("@smithy/core/client").CommandImpl<DeregisterTransitGatewayMulticastGroupMembersCommandInput, DeregisterTransitGatewayMulticastGroupMembersCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
