...
declare const DescribeLaunchTemplatesCommand_base: {
    new (input: DescribeLaunchTemplatesCommandInput): import("@smithy/core/client").CommandImpl<DescribeLaunchTemplatesCommandInput, DescribeLaunchTemplatesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLaunchTemplatesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLaunchTemplatesCommandInput, DescribeLaunchTemplatesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
