...
import type { ModifyInstanceCapacityReservationAttributesRequest, ModifyInstanceCapacityReservationAttributesResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyInstanceCapacityReservationAttributesCommand_base: {
    new (input: ModifyInstanceCapacityReservationAttributesCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCapacityReservationAttributesCommandInput, ModifyInstanceCapacityReservationAttributesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyInstanceCapacityReservationAttributesCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCapacityReservationAttributesCommandInput, ModifyInstanceCapacityReservationAttributesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
