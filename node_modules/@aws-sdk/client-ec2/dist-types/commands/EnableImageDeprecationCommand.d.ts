...
import type { EnableImageDeprecationRequest, EnableImageDeprecationResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableImageDeprecationCommand_base: {
    new (input: EnableImageDeprecationCommandInput): import("@smithy/core/client").CommandImpl<EnableImageDeprecationCommandInput, EnableImageDeprecationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableImageDeprecationCommandInput): import("@smithy/core/client").CommandImpl<EnableImageDeprecationCommandInput, EnableImageDeprecationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
