...
import type { ExportVerifiedAccessInstanceClientConfigurationRequest, ExportVerifiedAccessInstanceClientConfigurationResult } from "../models/models_5";
/**
 * @public
 */
...
declare const ExportVerifiedAccessInstanceClientConfigurationCommand_base: {
    new (input: ExportVerifiedAccessInstanceClientConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ExportVerifiedAccessInstanceClientConfigurationCommandInput, ExportVerifiedAccessInstanceClientConfigurationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ExportVerifiedAccessInstanceClientConfigurationCommandInput): import("@smithy/core/client").CommandImpl<ExportVerifiedAccessInstanceClientConfigurationCommandInput, ExportVerifiedAccessInstanceClientConfigurationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
