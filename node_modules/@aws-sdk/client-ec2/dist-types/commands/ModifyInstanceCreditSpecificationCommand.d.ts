...
import type { ModifyInstanceCreditSpecificationRequest, ModifyInstanceCreditSpecificationResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyInstanceCreditSpecificationCommand_base: {
    new (input: ModifyInstanceCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCreditSpecificationCommandInput, ModifyInstanceCreditSpecificationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyInstanceCreditSpecificationCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceCreditSpecificationCommandInput, ModifyInstanceCreditSpecificationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
