...
import type { ModifyIpamPrefixListResolverRequest, ModifyIpamPrefixListResolverResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyIpamPrefixListResolverCommand_base: {
    new (input: ModifyIpamPrefixListResolverCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPrefixListResolverCommandInput, ModifyIpamPrefixListResolverCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyIpamPrefixListResolverCommandInput): import("@smithy/core/client").CommandImpl<ModifyIpamPrefixListResolverCommandInput, ModifyIpamPrefixListResolverCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
