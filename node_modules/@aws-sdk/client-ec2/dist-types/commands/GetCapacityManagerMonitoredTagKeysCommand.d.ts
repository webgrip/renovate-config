...
import type { GetCapacityManagerMonitoredTagKeysRequest } from "../models/models_5";
import type { GetCapacityManagerMonitoredTagKeysResult } from "../models/models_6";
/**
 * @public
 */
...
declare const GetCapacityManagerMonitoredTagKeysCommand_base: {
    new (input: GetCapacityManagerMonitoredTagKeysCommandInput): import("@smithy/core/client").CommandImpl<GetCapacityManagerMonitoredTagKeysCommandInput, GetCapacityManagerMonitoredTagKeysCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetCapacityManagerMonitoredTagKeysCommandInput]): import("@smithy/core/client").CommandImpl<GetCapacityManagerMonitoredTagKeysCommandInput, GetCapacityManagerMonitoredTagKeysCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
