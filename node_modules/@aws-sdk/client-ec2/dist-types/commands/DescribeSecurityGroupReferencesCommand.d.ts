...
import type { DescribeSecurityGroupReferencesRequest, DescribeSecurityGroupReferencesResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeSecurityGroupReferencesCommand_base: {
    new (input: DescribeSecurityGroupReferencesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupReferencesCommandInput, DescribeSecurityGroupReferencesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeSecurityGroupReferencesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupReferencesCommandInput, DescribeSecurityGroupReferencesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
