...
declare const ModifyCapacityReservationCommand_base: {
    new (input: ModifyCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<ModifyCapacityReservationCommandInput, ModifyCapacityReservationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyCapacityReservationCommandInput): import("@smithy/core/client").CommandImpl<ModifyCapacityReservationCommandInput, ModifyCapacityReservationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
