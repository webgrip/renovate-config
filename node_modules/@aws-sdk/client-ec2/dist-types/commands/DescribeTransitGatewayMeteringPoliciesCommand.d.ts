...
declare const DescribeTransitGatewayMeteringPoliciesCommand_base: {
    new (input: DescribeTransitGatewayMeteringPoliciesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayMeteringPoliciesCommandInput, DescribeTransitGatewayMeteringPoliciesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTransitGatewayMeteringPoliciesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTransitGatewayMeteringPoliciesCommandInput, DescribeTransitGatewayMeteringPoliciesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
