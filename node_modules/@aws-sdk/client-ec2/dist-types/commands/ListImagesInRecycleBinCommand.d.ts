...
import type { ListImagesInRecycleBinRequest, ListImagesInRecycleBinResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ListImagesInRecycleBinCommand_base: {
    new (input: ListImagesInRecycleBinCommandInput): import("@smithy/core/client").CommandImpl<ListImagesInRecycleBinCommandInput, ListImagesInRecycleBinCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListImagesInRecycleBinCommandInput]): import("@smithy/core/client").CommandImpl<ListImagesInRecycleBinCommandInput, ListImagesInRecycleBinCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
