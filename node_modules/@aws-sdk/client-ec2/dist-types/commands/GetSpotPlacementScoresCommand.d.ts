...
declare const GetSpotPlacementScoresCommand_base: {
    new (input: GetSpotPlacementScoresCommandInput): import("@smithy/core/client").CommandImpl<GetSpotPlacementScoresCommandInput, GetSpotPlacementScoresCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetSpotPlacementScoresCommandInput): import("@smithy/core/client").CommandImpl<GetSpotPlacementScoresCommandInput, GetSpotPlacementScoresCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
