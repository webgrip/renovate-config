...
import type { EnableImageDeregistrationProtectionRequest, EnableImageDeregistrationProtectionResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableImageDeregistrationProtectionCommand_base: {
    new (input: EnableImageDeregistrationProtectionCommandInput): import("@smithy/core/client").CommandImpl<EnableImageDeregistrationProtectionCommandInput, EnableImageDeregistrationProtectionCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableImageDeregistrationProtectionCommandInput): import("@smithy/core/client").CommandImpl<EnableImageDeregistrationProtectionCommandInput, EnableImageDeregistrationProtectionCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
