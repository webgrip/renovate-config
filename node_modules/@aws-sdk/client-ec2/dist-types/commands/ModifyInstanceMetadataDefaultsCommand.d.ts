...
declare const ModifyInstanceMetadataDefaultsCommand_base: {
    new (input: ModifyInstanceMetadataDefaultsCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceMetadataDefaultsCommandInput, ModifyInstanceMetadataDefaultsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ModifyInstanceMetadataDefaultsCommandInput]): import("@smithy/core/client").CommandImpl<ModifyInstanceMetadataDefaultsCommandInput, ModifyInstanceMetadataDefaultsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
