...
declare const UpdateCapacityManagerMonitoredTagKeysCommand_base: {
    new (input: UpdateCapacityManagerMonitoredTagKeysCommandInput): import("@smithy/core/client").CommandImpl<UpdateCapacityManagerMonitoredTagKeysCommandInput, UpdateCapacityManagerMonitoredTagKeysCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [UpdateCapacityManagerMonitoredTagKeysCommandInput]): import("@smithy/core/client").CommandImpl<UpdateCapacityManagerMonitoredTagKeysCommandInput, UpdateCapacityManagerMonitoredTagKeysCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
