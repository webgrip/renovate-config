...
declare const DisableSnapshotBlockPublicAccessCommand_base: {
    new (input: DisableSnapshotBlockPublicAccessCommandInput): import("@smithy/core/client").CommandImpl<DisableSnapshotBlockPublicAccessCommandInput, DisableSnapshotBlockPublicAccessCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DisableSnapshotBlockPublicAccessCommandInput]): import("@smithy/core/client").CommandImpl<DisableSnapshotBlockPublicAccessCommandInput, DisableSnapshotBlockPublicAccessCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
