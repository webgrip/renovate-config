...
declare const DescribeScheduledInstancesCommand_base: {
    new (input: DescribeScheduledInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledInstancesCommandInput, DescribeScheduledInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeScheduledInstancesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeScheduledInstancesCommandInput, DescribeScheduledInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
