...
import type { EnableSerialConsoleAccessRequest, EnableSerialConsoleAccessResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableSerialConsoleAccessCommand_base: {
    new (input: EnableSerialConsoleAccessCommandInput): import("@smithy/core/client").CommandImpl<EnableSerialConsoleAccessCommandInput, EnableSerialConsoleAccessCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [EnableSerialConsoleAccessCommandInput]): import("@smithy/core/client").CommandImpl<EnableSerialConsoleAccessCommandInput, EnableSerialConsoleAccessCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
