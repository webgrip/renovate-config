...
import type { CreateClientVpnRouteRequest, CreateClientVpnRouteResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateClientVpnRouteCommand_base: {
    new (input: CreateClientVpnRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateClientVpnRouteCommandInput, CreateClientVpnRouteCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateClientVpnRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateClientVpnRouteCommandInput, CreateClientVpnRouteCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
