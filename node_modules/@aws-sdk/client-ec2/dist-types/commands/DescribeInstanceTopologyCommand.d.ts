...
declare const DescribeInstanceTopologyCommand_base: {
    new (input: DescribeInstanceTopologyCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceTopologyCommandInput, DescribeInstanceTopologyCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceTopologyCommandInput]): import("@smithy/core/client").CommandImpl<DescribeInstanceTopologyCommandInput, DescribeInstanceTopologyCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
