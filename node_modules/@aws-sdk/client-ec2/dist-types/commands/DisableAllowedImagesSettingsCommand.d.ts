...
declare const DisableAllowedImagesSettingsCommand_base: {
    new (input: DisableAllowedImagesSettingsCommandInput): import("@smithy/core/client").CommandImpl<DisableAllowedImagesSettingsCommandInput, DisableAllowedImagesSettingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DisableAllowedImagesSettingsCommandInput]): import("@smithy/core/client").CommandImpl<DisableAllowedImagesSettingsCommandInput, DisableAllowedImagesSettingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
