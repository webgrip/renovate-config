...
declare const DescribeHostReservationOfferingsCommand_base: {
    new (input: DescribeHostReservationOfferingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeHostReservationOfferingsCommandInput, DescribeHostReservationOfferingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeHostReservationOfferingsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeHostReservationOfferingsCommandInput, DescribeHostReservationOfferingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
