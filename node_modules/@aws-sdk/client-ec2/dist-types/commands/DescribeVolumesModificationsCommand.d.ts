...
declare const DescribeVolumesModificationsCommand_base: {
    new (input: DescribeVolumesModificationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVolumesModificationsCommandInput, DescribeVolumesModificationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVolumesModificationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVolumesModificationsCommandInput, DescribeVolumesModificationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
