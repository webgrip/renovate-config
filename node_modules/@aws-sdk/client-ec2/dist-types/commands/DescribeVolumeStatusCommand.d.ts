...
declare const DescribeVolumeStatusCommand_base: {
    new (input: DescribeVolumeStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeVolumeStatusCommandInput, DescribeVolumeStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVolumeStatusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVolumeStatusCommandInput, DescribeVolumeStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
