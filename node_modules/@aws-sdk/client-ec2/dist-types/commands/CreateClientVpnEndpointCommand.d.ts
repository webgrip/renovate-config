...
import type { CreateClientVpnEndpointRequest, CreateClientVpnEndpointResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateClientVpnEndpointCommand_base: {
    new (input: CreateClientVpnEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateClientVpnEndpointCommandInput, CreateClientVpnEndpointCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateClientVpnEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateClientVpnEndpointCommandInput, CreateClientVpnEndpointCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
