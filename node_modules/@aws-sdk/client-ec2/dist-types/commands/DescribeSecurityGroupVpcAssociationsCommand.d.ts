...
declare const DescribeSecurityGroupVpcAssociationsCommand_base: {
    new (input: DescribeSecurityGroupVpcAssociationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupVpcAssociationsCommandInput, DescribeSecurityGroupVpcAssociationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSecurityGroupVpcAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeSecurityGroupVpcAssociationsCommandInput, DescribeSecurityGroupVpcAssociationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
