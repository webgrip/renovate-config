...
import type { ModifyInstancePlacementRequest, ModifyInstancePlacementResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyInstancePlacementCommand_base: {
    new (input: ModifyInstancePlacementCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstancePlacementCommandInput, ModifyInstancePlacementCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyInstancePlacementCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstancePlacementCommandInput, ModifyInstancePlacementCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
