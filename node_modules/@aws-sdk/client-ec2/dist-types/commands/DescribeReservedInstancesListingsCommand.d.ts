...
declare const DescribeReservedInstancesListingsCommand_base: {
    new (input: DescribeReservedInstancesListingsCommandInput): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesListingsCommandInput, DescribeReservedInstancesListingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeReservedInstancesListingsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeReservedInstancesListingsCommandInput, DescribeReservedInstancesListingsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
