...
declare const GetIpamPoolAllocationsCommand_base: {
    new (input: GetIpamPoolAllocationsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPoolAllocationsCommandInput, GetIpamPoolAllocationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetIpamPoolAllocationsCommandInput): import("@smithy/core/client").CommandImpl<GetIpamPoolAllocationsCommandInput, GetIpamPoolAllocationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
