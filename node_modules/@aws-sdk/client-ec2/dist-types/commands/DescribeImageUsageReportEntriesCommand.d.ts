...
declare const DescribeImageUsageReportEntriesCommand_base: {
    new (input: DescribeImageUsageReportEntriesCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageUsageReportEntriesCommandInput, DescribeImageUsageReportEntriesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeImageUsageReportEntriesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeImageUsageReportEntriesCommandInput, DescribeImageUsageReportEntriesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
