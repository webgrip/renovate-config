...
declare const DescribeTrafficMirrorTargetsCommand_base: {
    new (input: DescribeTrafficMirrorTargetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorTargetsCommandInput, DescribeTrafficMirrorTargetsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeTrafficMirrorTargetsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeTrafficMirrorTargetsCommandInput, DescribeTrafficMirrorTargetsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
