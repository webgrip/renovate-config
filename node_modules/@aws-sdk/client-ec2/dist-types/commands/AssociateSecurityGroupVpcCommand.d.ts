...
declare const AssociateSecurityGroupVpcCommand_base: {
    new (input: AssociateSecurityGroupVpcCommandInput): import("@smithy/core/client").CommandImpl<AssociateSecurityGroupVpcCommandInput, AssociateSecurityGroupVpcCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: AssociateSecurityGroupVpcCommandInput): import("@smithy/core/client").CommandImpl<AssociateSecurityGroupVpcCommandInput, AssociateSecurityGroupVpcCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
