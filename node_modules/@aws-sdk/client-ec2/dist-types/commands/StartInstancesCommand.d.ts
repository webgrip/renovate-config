...
import type { StartInstancesRequest, StartInstancesResult } from "../models/models_7";
/**
 * @public
 */
...
declare const StartInstancesCommand_base: {
    new (input: StartInstancesCommandInput): import("@smithy/core/client").CommandImpl<StartInstancesCommandInput, StartInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StartInstancesCommandInput): import("@smithy/core/client").CommandImpl<StartInstancesCommandInput, StartInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
