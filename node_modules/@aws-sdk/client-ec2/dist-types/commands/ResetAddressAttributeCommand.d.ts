...
import type { ResetAddressAttributeRequest, ResetAddressAttributeResult } from "../models/models_7";
/**
 * @public
 */
...
declare const ResetAddressAttributeCommand_base: {
    new (input: ResetAddressAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetAddressAttributeCommandInput, ResetAddressAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ResetAddressAttributeCommandInput): import("@smithy/core/client").CommandImpl<ResetAddressAttributeCommandInput, ResetAddressAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
