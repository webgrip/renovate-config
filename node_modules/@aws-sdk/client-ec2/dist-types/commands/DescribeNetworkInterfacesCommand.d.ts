...
declare const DescribeNetworkInterfacesCommand_base: {
    new (input: DescribeNetworkInterfacesCommandInput): import("@smithy/core/client").CommandImpl<DescribeNetworkInterfacesCommandInput, DescribeNetworkInterfacesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNetworkInterfacesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNetworkInterfacesCommandInput, DescribeNetworkInterfacesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
