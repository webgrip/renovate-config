...
declare const DescribeRouteServerPeersCommand_base: {
    new (input: DescribeRouteServerPeersCommandInput): import("@smithy/core/client").CommandImpl<DescribeRouteServerPeersCommandInput, DescribeRouteServerPeersCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeRouteServerPeersCommandInput]): import("@smithy/core/client").CommandImpl<DescribeRouteServerPeersCommandInput, DescribeRouteServerPeersCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
