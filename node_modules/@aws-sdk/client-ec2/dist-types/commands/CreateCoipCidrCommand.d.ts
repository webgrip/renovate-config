...
import type { CreateCoipCidrRequest, CreateCoipCidrResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateCoipCidrCommand_base: {
    new (input: CreateCoipCidrCommandInput): import("@smithy/core/client").CommandImpl<CreateCoipCidrCommandInput, CreateCoipCidrCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateCoipCidrCommandInput): import("@smithy/core/client").CommandImpl<CreateCoipCidrCommandInput, CreateCoipCidrCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
