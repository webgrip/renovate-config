...
import type { CreateRestoreImageTaskRequest, CreateRestoreImageTaskResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateRestoreImageTaskCommand_base: {
    new (input: CreateRestoreImageTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateRestoreImageTaskCommandInput, CreateRestoreImageTaskCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateRestoreImageTaskCommandInput): import("@smithy/core/client").CommandImpl<CreateRestoreImageTaskCommandInput, CreateRestoreImageTaskCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
