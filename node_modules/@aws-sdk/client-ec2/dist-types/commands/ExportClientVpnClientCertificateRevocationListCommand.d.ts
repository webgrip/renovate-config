...
import type { ExportClientVpnClientCertificateRevocationListRequest, ExportClientVpnClientCertificateRevocationListResult } from "../models/models_5";
/**
 * @public
 */
...
declare const ExportClientVpnClientCertificateRevocationListCommand_base: {
    new (input: ExportClientVpnClientCertificateRevocationListCommandInput): import("@smithy/core/client").CommandImpl<ExportClientVpnClientCertificateRevocationListCommandInput, ExportClientVpnClientCertificateRevocationListCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ExportClientVpnClientCertificateRevocationListCommandInput): import("@smithy/core/client").CommandImpl<ExportClientVpnClientCertificateRevocationListCommandInput, ExportClientVpnClientCertificateRevocationListCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
