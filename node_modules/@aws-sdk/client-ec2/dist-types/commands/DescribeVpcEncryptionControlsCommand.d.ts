...
declare const DescribeVpcEncryptionControlsCommand_base: {
    new (input: DescribeVpcEncryptionControlsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpcEncryptionControlsCommandInput, DescribeVpcEncryptionControlsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpcEncryptionControlsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpcEncryptionControlsCommandInput, DescribeVpcEncryptionControlsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
