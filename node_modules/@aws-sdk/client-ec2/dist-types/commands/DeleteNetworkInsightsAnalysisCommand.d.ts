...
import type { DeleteNetworkInsightsAnalysisRequest, DeleteNetworkInsightsAnalysisResult } from "../models/models_2";
/**
 * @public
 */
...
declare const DeleteNetworkInsightsAnalysisCommand_base: {
    new (input: DeleteNetworkInsightsAnalysisCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInsightsAnalysisCommandInput, DeleteNetworkInsightsAnalysisCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteNetworkInsightsAnalysisCommandInput): import("@smithy/core/client").CommandImpl<DeleteNetworkInsightsAnalysisCommandInput, DeleteNetworkInsightsAnalysisCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
