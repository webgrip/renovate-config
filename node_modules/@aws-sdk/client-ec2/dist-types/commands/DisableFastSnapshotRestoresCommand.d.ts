...
declare const DisableFastSnapshotRestoresCommand_base: {
    new (input: DisableFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<DisableFastSnapshotRestoresCommandInput, DisableFastSnapshotRestoresCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DisableFastSnapshotRestoresCommandInput): import("@smithy/core/client").CommandImpl<DisableFastSnapshotRestoresCommandInput, DisableFastSnapshotRestoresCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
