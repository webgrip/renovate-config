...
import type { EnableVgwRoutePropagationRequest } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableVgwRoutePropagationCommand_base: {
    new (input: EnableVgwRoutePropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableVgwRoutePropagationCommandInput, EnableVgwRoutePropagationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableVgwRoutePropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableVgwRoutePropagationCommandInput, EnableVgwRoutePropagationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
