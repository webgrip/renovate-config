...
declare const DescribeVerifiedAccessInstancesCommand_base: {
    new (input: DescribeVerifiedAccessInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessInstancesCommandInput, DescribeVerifiedAccessInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVerifiedAccessInstancesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVerifiedAccessInstancesCommandInput, DescribeVerifiedAccessInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
