...
declare const DescribeIpamPrefixListResolversCommand_base: {
    new (input: DescribeIpamPrefixListResolversCommandInput): import("@smithy/core/client").CommandImpl<DescribeIpamPrefixListResolversCommandInput, DescribeIpamPrefixListResolversCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIpamPrefixListResolversCommandInput]): import("@smithy/core/client").CommandImpl<DescribeIpamPrefixListResolversCommandInput, DescribeIpamPrefixListResolversCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
