...
import type { RevokeSecurityGroupEgressRequest, RevokeSecurityGroupEgressResult } from "../models/models_7";
/**
 * @public
 */
...
declare const RevokeSecurityGroupEgressCommand_base: {
    new (input: RevokeSecurityGroupEgressCommandInput): import("@smithy/core/client").CommandImpl<RevokeSecurityGroupEgressCommandInput, RevokeSecurityGroupEgressCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: RevokeSecurityGroupEgressCommandInput): import("@smithy/core/client").CommandImpl<RevokeSecurityGroupEgressCommandInput, RevokeSecurityGroupEgressCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
