...
declare const DescribeCapacityBlockStatusCommand_base: {
    new (input: DescribeCapacityBlockStatusCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockStatusCommandInput, DescribeCapacityBlockStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityBlockStatusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityBlockStatusCommandInput, DescribeCapacityBlockStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
