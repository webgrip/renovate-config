...
import type { EnableInstanceSqlHaStandbyDetectionsRequest, EnableInstanceSqlHaStandbyDetectionsResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableInstanceSqlHaStandbyDetectionsCommand_base: {
    new (input: EnableInstanceSqlHaStandbyDetectionsCommandInput): import("@smithy/core/client").CommandImpl<EnableInstanceSqlHaStandbyDetectionsCommandInput, EnableInstanceSqlHaStandbyDetectionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableInstanceSqlHaStandbyDetectionsCommandInput): import("@smithy/core/client").CommandImpl<EnableInstanceSqlHaStandbyDetectionsCommandInput, EnableInstanceSqlHaStandbyDetectionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
