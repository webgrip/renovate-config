...
declare const DescribeLocalGatewayVirtualInterfacesCommand_base: {
    new (input: DescribeLocalGatewayVirtualInterfacesCommandInput): import("@smithy/core/client").CommandImpl<DescribeLocalGatewayVirtualInterfacesCommandInput, DescribeLocalGatewayVirtualInterfacesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLocalGatewayVirtualInterfacesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLocalGatewayVirtualInterfacesCommandInput, DescribeLocalGatewayVirtualInterfacesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
