...
declare const DisableVpcClassicLinkDnsSupportCommand_base: {
    new (input: DisableVpcClassicLinkDnsSupportCommandInput): import("@smithy/core/client").CommandImpl<DisableVpcClassicLinkDnsSupportCommandInput, DisableVpcClassicLinkDnsSupportCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DisableVpcClassicLinkDnsSupportCommandInput]): import("@smithy/core/client").CommandImpl<DisableVpcClassicLinkDnsSupportCommandInput, DisableVpcClassicLinkDnsSupportCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
