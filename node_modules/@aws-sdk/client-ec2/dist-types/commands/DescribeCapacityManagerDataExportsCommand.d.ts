...
declare const DescribeCapacityManagerDataExportsCommand_base: {
    new (input: DescribeCapacityManagerDataExportsCommandInput): import("@smithy/core/client").CommandImpl<DescribeCapacityManagerDataExportsCommandInput, DescribeCapacityManagerDataExportsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityManagerDataExportsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeCapacityManagerDataExportsCommandInput, DescribeCapacityManagerDataExportsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
