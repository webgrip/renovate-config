...
import type { ModifyInstanceEventWindowRequest, ModifyInstanceEventWindowResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ModifyInstanceEventWindowCommand_base: {
    new (input: ModifyInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceEventWindowCommandInput, ModifyInstanceEventWindowCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyInstanceEventWindowCommandInput): import("@smithy/core/client").CommandImpl<ModifyInstanceEventWindowCommandInput, ModifyInstanceEventWindowCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
