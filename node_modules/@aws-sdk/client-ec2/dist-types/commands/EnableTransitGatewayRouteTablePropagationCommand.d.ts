...
import type { EnableTransitGatewayRouteTablePropagationRequest, EnableTransitGatewayRouteTablePropagationResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableTransitGatewayRouteTablePropagationCommand_base: {
    new (input: EnableTransitGatewayRouteTablePropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableTransitGatewayRouteTablePropagationCommandInput, EnableTransitGatewayRouteTablePropagationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableTransitGatewayRouteTablePropagationCommandInput): import("@smithy/core/client").CommandImpl<EnableTransitGatewayRouteTablePropagationCommandInput, EnableTransitGatewayRouteTablePropagationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
