...
import type { GetAssociatedEnclaveCertificateIamRolesRequest, GetAssociatedEnclaveCertificateIamRolesResult } from "../models/models_5";
/**
 * @public
 */
...
declare const GetAssociatedEnclaveCertificateIamRolesCommand_base: {
    new (input: GetAssociatedEnclaveCertificateIamRolesCommandInput): import("@smithy/core/client").CommandImpl<GetAssociatedEnclaveCertificateIamRolesCommandInput, GetAssociatedEnclaveCertificateIamRolesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAssociatedEnclaveCertificateIamRolesCommandInput): import("@smithy/core/client").CommandImpl<GetAssociatedEnclaveCertificateIamRolesCommandInput, GetAssociatedEnclaveCertificateIamRolesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
