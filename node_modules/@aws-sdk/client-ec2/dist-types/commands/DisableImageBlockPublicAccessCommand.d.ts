...
declare const DisableImageBlockPublicAccessCommand_base: {
    new (input: DisableImageBlockPublicAccessCommandInput): import("@smithy/core/client").CommandImpl<DisableImageBlockPublicAccessCommandInput, DisableImageBlockPublicAccessCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DisableImageBlockPublicAccessCommandInput]): import("@smithy/core/client").CommandImpl<DisableImageBlockPublicAccessCommandInput, DisableImageBlockPublicAccessCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
