...
import type { EnableIpamOrganizationAdminAccountRequest, EnableIpamOrganizationAdminAccountResult } from "../models/models_5";
/**
 * @public
 */
...
declare const EnableIpamOrganizationAdminAccountCommand_base: {
    new (input: EnableIpamOrganizationAdminAccountCommandInput): import("@smithy/core/client").CommandImpl<EnableIpamOrganizationAdminAccountCommandInput, EnableIpamOrganizationAdminAccountCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableIpamOrganizationAdminAccountCommandInput): import("@smithy/core/client").CommandImpl<EnableIpamOrganizationAdminAccountCommandInput, EnableIpamOrganizationAdminAccountCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
