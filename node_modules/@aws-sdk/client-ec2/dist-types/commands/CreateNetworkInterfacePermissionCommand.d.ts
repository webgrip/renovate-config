...
import type { CreateNetworkInterfacePermissionRequest, CreateNetworkInterfacePermissionResult } from "../models/models_1";
/**
 * @public
 */
...
declare const CreateNetworkInterfacePermissionCommand_base: {
    new (input: CreateNetworkInterfacePermissionCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInterfacePermissionCommandInput, CreateNetworkInterfacePermissionCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateNetworkInterfacePermissionCommandInput): import("@smithy/core/client").CommandImpl<CreateNetworkInterfacePermissionCommandInput, CreateNetworkInterfacePermissionCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
