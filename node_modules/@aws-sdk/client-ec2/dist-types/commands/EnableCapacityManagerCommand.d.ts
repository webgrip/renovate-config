...
declare const EnableCapacityManagerCommand_base: {
    new (input: EnableCapacityManagerCommandInput): import("@smithy/core/client").CommandImpl<EnableCapacityManagerCommandInput, EnableCapacityManagerCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [EnableCapacityManagerCommandInput]): import("@smithy/core/client").CommandImpl<EnableCapacityManagerCommandInput, EnableCapacityManagerCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
