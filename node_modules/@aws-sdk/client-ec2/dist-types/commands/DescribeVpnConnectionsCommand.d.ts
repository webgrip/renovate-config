...
declare const DescribeVpnConnectionsCommand_base: {
    new (input: DescribeVpnConnectionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeVpnConnectionsCommandInput, DescribeVpnConnectionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeVpnConnectionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeVpnConnectionsCommandInput, DescribeVpnConnectionsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
