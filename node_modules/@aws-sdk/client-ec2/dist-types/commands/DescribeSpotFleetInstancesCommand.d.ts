...
import type { DescribeSpotFleetInstancesRequest, DescribeSpotFleetInstancesResponse } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeSpotFleetInstancesCommand_base: {
    new (input: DescribeSpotFleetInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetInstancesCommandInput, DescribeSpotFleetInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeSpotFleetInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpotFleetInstancesCommandInput, DescribeSpotFleetInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
