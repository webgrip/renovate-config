...
import type { UpdateSecurityGroupRuleDescriptionsEgressRequest, UpdateSecurityGroupRuleDescriptionsEgressResult } from "../models/models_7";
/**
 * @public
 */
...
declare const UpdateSecurityGroupRuleDescriptionsEgressCommand_base: {
    new (input: UpdateSecurityGroupRuleDescriptionsEgressCommandInput): import("@smithy/core/client").CommandImpl<UpdateSecurityGroupRuleDescriptionsEgressCommandInput, UpdateSecurityGroupRuleDescriptionsEgressCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [UpdateSecurityGroupRuleDescriptionsEgressCommandInput]): import("@smithy/core/client").CommandImpl<UpdateSecurityGroupRuleDescriptionsEgressCommandInput, UpdateSecurityGroupRuleDescriptionsEgressCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
