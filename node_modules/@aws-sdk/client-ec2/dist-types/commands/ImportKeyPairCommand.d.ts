...
import type { ImportKeyPairRequest, ImportKeyPairResult } from "../models/models_6";
/**
 * @public
 */
...
declare const ImportKeyPairCommand_base: {
    new (input: ImportKeyPairCommandInput): import("@smithy/core/client").CommandImpl<ImportKeyPairCommandInput, ImportKeyPairCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ImportKeyPairCommandInput): import("@smithy/core/client").CommandImpl<ImportKeyPairCommandInput, ImportKeyPairCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
