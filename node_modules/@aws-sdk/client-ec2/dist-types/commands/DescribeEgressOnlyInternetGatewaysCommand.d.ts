...
declare const DescribeEgressOnlyInternetGatewaysCommand_base: {
    new (input: DescribeEgressOnlyInternetGatewaysCommandInput): import("@smithy/core/client").CommandImpl<DescribeEgressOnlyInternetGatewaysCommandInput, DescribeEgressOnlyInternetGatewaysCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeEgressOnlyInternetGatewaysCommandInput]): import("@smithy/core/client").CommandImpl<DescribeEgressOnlyInternetGatewaysCommandInput, DescribeEgressOnlyInternetGatewaysCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
