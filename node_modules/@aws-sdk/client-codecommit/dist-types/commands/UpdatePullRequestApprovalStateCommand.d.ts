...
import type { UpdatePullRequestApprovalStateInput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdatePullRequestApprovalStateCommand_base: {
    new (input: UpdatePullRequestApprovalStateCommandInput): import("@smithy/core/client").CommandImpl<UpdatePullRequestApprovalStateCommandInput, UpdatePullRequestApprovalStateCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdatePullRequestApprovalStateCommandInput): import("@smithy/core/client").CommandImpl<UpdatePullRequestApprovalStateCommandInput, UpdatePullRequestApprovalStateCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
