...
import type { CreateBranchInput } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateBranchCommand_base: {
    new (input: CreateBranchCommandInput): import("@smithy/core/client").CommandImpl<CreateBranchCommandInput, CreateBranchCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateBranchCommandInput): import("@smithy/core/client").CommandImpl<CreateBranchCommandInput, CreateBranchCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
