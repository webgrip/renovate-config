...
import type { BatchGetRepositoriesInput, BatchGetRepositoriesOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const BatchGetRepositoriesCommand_base: {
    new (input: BatchGetRepositoriesCommandInput): import("@smithy/core/client").CommandImpl<BatchGetRepositoriesCommandInput, BatchGetRepositoriesCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: BatchGetRepositoriesCommandInput): import("@smithy/core/client").CommandImpl<BatchGetRepositoriesCommandInput, BatchGetRepositoriesCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
