...
import type { DisassociateApprovalRuleTemplateFromRepositoryInput } from "../models/models_0";
/**
 * @public
 */
...
declare const DisassociateApprovalRuleTemplateFromRepositoryCommand_base: {
    new (input: DisassociateApprovalRuleTemplateFromRepositoryCommandInput): import("@smithy/core/client").CommandImpl<DisassociateApprovalRuleTemplateFromRepositoryCommandInput, DisassociateApprovalRuleTemplateFromRepositoryCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DisassociateApprovalRuleTemplateFromRepositoryCommandInput): import("@smithy/core/client").CommandImpl<DisassociateApprovalRuleTemplateFromRepositoryCommandInput, DisassociateApprovalRuleTemplateFromRepositoryCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
