...
import type { EvaluatePullRequestApprovalRulesInput, EvaluatePullRequestApprovalRulesOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const EvaluatePullRequestApprovalRulesCommand_base: {
    new (input: EvaluatePullRequestApprovalRulesCommandInput): import("@smithy/core/client").CommandImpl<EvaluatePullRequestApprovalRulesCommandInput, EvaluatePullRequestApprovalRulesCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EvaluatePullRequestApprovalRulesCommandInput): import("@smithy/core/client").CommandImpl<EvaluatePullRequestApprovalRulesCommandInput, EvaluatePullRequestApprovalRulesCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
