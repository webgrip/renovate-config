...
import type { ListBranchesInput, ListBranchesOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListBranchesCommand_base: {
    new (input: ListBranchesCommandInput): import("@smithy/core/client").CommandImpl<ListBranchesCommandInput, ListBranchesCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListBranchesCommandInput): import("@smithy/core/client").CommandImpl<ListBranchesCommandInput, ListBranchesCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
