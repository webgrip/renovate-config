...
import type { BatchGetCommitsInput, BatchGetCommitsOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const BatchGetCommitsCommand_base: {
    new (input: BatchGetCommitsCommandInput): import("@smithy/core/client").CommandImpl<BatchGetCommitsCommandInput, BatchGetCommitsCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: BatchGetCommitsCommandInput): import("@smithy/core/client").CommandImpl<BatchGetCommitsCommandInput, BatchGetCommitsCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
