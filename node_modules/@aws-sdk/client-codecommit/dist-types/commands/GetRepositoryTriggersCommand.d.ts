...
import type { GetRepositoryTriggersInput, GetRepositoryTriggersOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetRepositoryTriggersCommand_base: {
    new (input: GetRepositoryTriggersCommandInput): import("@smithy/core/client").CommandImpl<GetRepositoryTriggersCommandInput, GetRepositoryTriggersCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetRepositoryTriggersCommandInput): import("@smithy/core/client").CommandImpl<GetRepositoryTriggersCommandInput, GetRepositoryTriggersCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
