...
import type { ListRepositoriesForApprovalRuleTemplateInput, ListRepositoriesForApprovalRuleTemplateOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListRepositoriesForApprovalRuleTemplateCommand_base: {
    new (input: ListRepositoriesForApprovalRuleTemplateCommandInput): import("@smithy/core/client").CommandImpl<ListRepositoriesForApprovalRuleTemplateCommandInput, ListRepositoriesForApprovalRuleTemplateCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListRepositoriesForApprovalRuleTemplateCommandInput): import("@smithy/core/client").CommandImpl<ListRepositoriesForApprovalRuleTemplateCommandInput, ListRepositoriesForApprovalRuleTemplateCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
