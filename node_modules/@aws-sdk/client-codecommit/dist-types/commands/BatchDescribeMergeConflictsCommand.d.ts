...
import type { BatchDescribeMergeConflictsInput, BatchDescribeMergeConflictsOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const BatchDescribeMergeConflictsCommand_base: {
    new (input: BatchDescribeMergeConflictsCommandInput): import("@smithy/core/client").CommandImpl<BatchDescribeMergeConflictsCommandInput, BatchDescribeMergeConflictsCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: BatchDescribeMergeConflictsCommandInput): import("@smithy/core/client").CommandImpl<BatchDescribeMergeConflictsCommandInput, BatchDescribeMergeConflictsCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
