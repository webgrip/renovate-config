...
import type { GetCommentInput, GetCommentOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetCommentCommand_base: {
    new (input: GetCommentCommandInput): import("@smithy/core/client").CommandImpl<GetCommentCommandInput, GetCommentCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetCommentCommandInput): import("@smithy/core/client").CommandImpl<GetCommentCommandInput, GetCommentCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
