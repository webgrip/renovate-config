...
import type { UpdatePullRequestTitleInput, UpdatePullRequestTitleOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdatePullRequestTitleCommand_base: {
    new (input: UpdatePullRequestTitleCommandInput): import("@smithy/core/client").CommandImpl<UpdatePullRequestTitleCommandInput, UpdatePullRequestTitleCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdatePullRequestTitleCommandInput): import("@smithy/core/client").CommandImpl<UpdatePullRequestTitleCommandInput, UpdatePullRequestTitleCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
