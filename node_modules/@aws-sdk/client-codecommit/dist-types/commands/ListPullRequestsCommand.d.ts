...
import type { ListPullRequestsInput, ListPullRequestsOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListPullRequestsCommand_base: {
    new (input: ListPullRequestsCommandInput): import("@smithy/core/client").CommandImpl<ListPullRequestsCommandInput, ListPullRequestsCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListPullRequestsCommandInput): import("@smithy/core/client").CommandImpl<ListPullRequestsCommandInput, ListPullRequestsCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
