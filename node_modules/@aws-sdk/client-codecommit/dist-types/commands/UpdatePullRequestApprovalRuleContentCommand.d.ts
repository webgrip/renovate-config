...
import type { UpdatePullRequestApprovalRuleContentInput, UpdatePullRequestApprovalRuleContentOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdatePullRequestApprovalRuleContentCommand_base: {
    new (input: UpdatePullRequestApprovalRuleContentCommandInput): import("@smithy/core/client").CommandImpl<UpdatePullRequestApprovalRuleContentCommandInput, UpdatePullRequestApprovalRuleContentCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdatePullRequestApprovalRuleContentCommandInput): import("@smithy/core/client").CommandImpl<UpdatePullRequestApprovalRuleContentCommandInput, UpdatePullRequestApprovalRuleContentCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
