...
import type { GetPullRequestInput, GetPullRequestOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const GetPullRequestCommand_base: {
    new (input: GetPullRequestCommandInput): import("@smithy/core/client").CommandImpl<GetPullRequestCommandInput, GetPullRequestCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetPullRequestCommandInput): import("@smithy/core/client").CommandImpl<GetPullRequestCommandInput, GetPullRequestCommandOutput, CodeCommitClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
