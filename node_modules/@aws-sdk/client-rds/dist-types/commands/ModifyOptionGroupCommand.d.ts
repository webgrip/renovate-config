...
import type { ModifyOptionGroupMessage, ModifyOptionGroupResult } from "../models/models_1";
...
declare const ModifyOptionGroupCommand_base: {
    new (input: ModifyOptionGroupCommandInput): import("@smithy/core/client").CommandImpl<ModifyOptionGroupCommandInput, ModifyOptionGroupCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ModifyOptionGroupCommandInput): import("@smithy/core/client").CommandImpl<ModifyOptionGroupCommandInput, ModifyOptionGroupCommandOutput, RDSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
