...
import type { DescribeInsightRequest, DescribeInsightResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeInsightCommand_base: {
    new (input: DescribeInsightCommandInput): import("@smithy/core/client").CommandImpl<DescribeInsightCommandInput, DescribeInsightCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeInsightCommandInput): import("@smithy/core/client").CommandImpl<DescribeInsightCommandInput, DescribeInsightCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
