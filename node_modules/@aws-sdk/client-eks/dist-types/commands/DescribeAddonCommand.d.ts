...
import type { DescribeAddonRequest, DescribeAddonResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeAddonCommand_base: {
    new (input: DescribeAddonCommandInput): import("@smithy/core/client").CommandImpl<DescribeAddonCommandInput, DescribeAddonCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeAddonCommandInput): import("@smithy/core/client").CommandImpl<DescribeAddonCommandInput, DescribeAddonCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
