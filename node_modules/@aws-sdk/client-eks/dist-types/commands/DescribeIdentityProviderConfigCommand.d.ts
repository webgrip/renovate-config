...
import type { DescribeIdentityProviderConfigRequest, DescribeIdentityProviderConfigResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeIdentityProviderConfigCommand_base: {
    new (input: DescribeIdentityProviderConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeIdentityProviderConfigCommandInput, DescribeIdentityProviderConfigCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeIdentityProviderConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeIdentityProviderConfigCommandInput, DescribeIdentityProviderConfigCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
