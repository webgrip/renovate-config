...
import type { DescribeEksAnywhereSubscriptionRequest, DescribeEksAnywhereSubscriptionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeEksAnywhereSubscriptionCommand_base: {
    new (input: DescribeEksAnywhereSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<DescribeEksAnywhereSubscriptionCommandInput, DescribeEksAnywhereSubscriptionCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeEksAnywhereSubscriptionCommandInput): import("@smithy/core/client").CommandImpl<DescribeEksAnywhereSubscriptionCommandInput, DescribeEksAnywhereSubscriptionCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
