...
import type { DescribeAddonVersionsRequest, DescribeAddonVersionsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeAddonVersionsCommand_base: {
    new (input: DescribeAddonVersionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeAddonVersionsCommandInput, DescribeAddonVersionsCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAddonVersionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAddonVersionsCommandInput, DescribeAddonVersionsCommandOutput, EKSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
